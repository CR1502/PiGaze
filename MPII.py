...
class MPIIFaceGazeDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        label = np.concatenate([sample['gaze_target'], sample['head_pose']])
...
class PiGazeModel(nn.Module):
    def __init__(self):
        ...
        self.classifier = nn.Sequential(
            ...
            nn.Linear(64, 32),
            nn.ReLU(inplace=True),
            nn.Linear(32, 9)  # 3 for gaze target, 6 for head pose
        )
...
data_path = '/Users/soorya/Downloads/dataverse_files/MPIIFaceGaze/Data'
...
# print(f"Predicted gaze target: {gaze_target}")
# print(f"Predicted head pose: {head_pose}")